...
;var w=m("yt.events.events.listeners_")||{};u("yt.events.events.listeners_",w);var yb=m("yt.events.events.counter_")||{count:0};u("yt.events.events.counter_",yb);function zb(a,b,c){a.addEventListener&&("mouseenter"!=b||"onmouseenter"in document?"mouseleave"!=b||"onmouseenter"in document?"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"):b="mouseout":b="mouseover");return ja(function(d){return d[0]==a&&d[1]==b&&d[2]==c&&0==d[4]})}
