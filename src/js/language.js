...
function localizeHtmlPage(){$("[langchrome]").each(function(){	
...
if($(this).attr("titlepst") == "left"){document.title = titlepst+chrome.i18n.getMessage(setlangchrome)}
...
else if($(this).attr("titlepst") == "leftEX"){document.title = chrome.i18n.getMessage("appName")+" - "+chrome.i18n.getMessage(setlangchrome)}

else if($(this).attr("titlepst") == "rightEX"){document.title = chrome.i18n.getMessage(setlangchrome)+" - "+chrome.i18n.getMessage("appName")}

else{document.title = chrome.i18n.getMessage(setlangchrome)}
