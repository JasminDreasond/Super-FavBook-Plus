...
if(appopen == "all"){window.open(chrome.extension.getURL('index.html'), "_blank");}
else if(appopen == "appdevianplus"){chrome.windows.create({url: "apps/devianplus.html", type: "popup", state: "maximized"});}
else if(appopen == "appsoundbookplus"){chrome.windows.create({url: "apps/soundbookplus.html", type: "popup", state: "maximized"});}
else if(appopen == "appfanficbookinplus"){chrome.windows.create({url: "apps/fanficbookinplus.html", type: "popup", state: "maximized"});}
window.close();
}


if($("#loadcscsstype").val() == 'sync'){
if($("#installselect").val() == "all"){chrome.storage.sync.set({dp_css: download_st.download_code_css, sb_css: download_st.download_code_css, ffb_css: download_st.download_code_css}, function(){window.close();})}
else if($("#installselect").val() == "appdevianplus"){chrome.storage.sync.set({dp_css: download_st.download_code_css}, function(){installedsucess($("#installselect").val());})}
else if($("#installselect").val() == "appsoundbookplus"){chrome.storage.sync.set({sb_css: download_st.download_code_css}, function(){installedsucess($("#installselect").val());})}
else if($("#installselect").val() == "appfanficbookinplus"){chrome.storage.sync.set({ffb_css: download_st.download_code_css}, function(){installedsucess($("#installselect").val());})}
}

else{
if($("#installselect").val() == "all"){chrome.storage.local.set({dp_css: download_st.download_code_css, sb_css: download_st.download_code_css, ffb_css: download_st.download_code_css}, function(){installedsucess($("#installselect").val());})}
else if($("#installselect").val() == "appdevianplus"){chrome.storage.local.set({dp_css: download_st.download_code_css}, function(){installedsucess($("#installselect").val());})}
else if($("#installselect").val() == "appsoundbookplus"){chrome.storage.local.set({sb_css: download_st.download_code_css}, function(){installedsucess($("#installselect").val());})}
else if($("#installselect").val() == "appfanficbookinplus"){chrome.storage.local.set({ffb_css: download_st.download_code_css}, function(){installedsucess($("#installselect").val());})}
}
...
chrome.storage.local.set({download_code_css: ""});} else{window.close();}});} startdownloadst();