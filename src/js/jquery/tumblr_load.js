...
// Vars
var tumblr_show; var limit_tumblr_load;
...
if(newtagst != null){var tagselectedtumblr = newtagst;}
else{var tagselectedtumblr = data.tag; newtagst = data.tag;}
}
...
if(data.page > 0){
if(data2.limit > 0){var load_tumblr_lm = data2.limit;}
else if((data2.limit > 20) || (data2.limit == null) || (data2.limit == 0) || (data2.limit == undefined) || (isNaN(data2.limit) == true)){var load_tumblr_lm = 20;}
...
.done(function(tumblr){if(($(this).attr("id") != null) || ($(this).attr("id") != undefined) || ($(this).attr("id") != '')){
...
// Disable Tag
if(data2.disable_tag == true){if((newtagst != null) && (newtagst != undefined) && (newtagst != '')){

if((data.type != "tags") || (data2.force_disable_tag == true)){
$('#'+$(thishere).attr('id')+" .tumblr_head_page").append($("<h3>", {class: "tumblr_remove_tag"}).append(
$("<button>", {type: "button", class: "btn btn-default"}).text(chrome.i18n.getMessage("tumblr_removetag")+": ").append($("<strong>").text(decodeURIComponent(newtagst))).click(function(){load_tumblr_disable_click(); $(thishere).tumblr(data, data2, true, 0, antiscroll, '')})
));
}
...
if(data2.limit <= 0){limit_tumblr_load = tumblr.posts.length;}
else{limit_tumblr_load = data2.limit;}
for (numberpost = 0; numberpost < limit_tumblr_load; numberpost++) {if(tumblr.posts[numberpost] != undefined){
...
antiinfotmb = 'hide';}
else{tumblr.posts[numberpost]["quote-source"] = "— "+tumblr.posts[numberpost]["quote-source"]; antiinfotmb = '';}
if(data2.like == false){tumblr.posts[numberpost]["like-button"] = ''; antliketmb = 'hide';} else{antliketmb = '';}
if(data2.reblog == false){tumblr.posts[numberpost]["reblog-button"] = ''; antreblogtmb = 'hide';} else{antreblogtmb = '';}
if((data2.like == false) && (data2.reblog == false)){antsharetmb = 'hide';} else{antsharetmb = '';}
if(data2.date == false){tumblr.posts[numberpost].date = ''; antdatetmb = 'hide';} else{antdatetmb = '';}
if(data2.music == false){tumblr.posts[numberpost]["audio-player"] = ''; antmusictmb = 'hide';} else{antmusictmb = '';}
if(data2.photo == false){tumblr.posts[numberpost]["photo-url-1280"] = ''; antiimgtmb = 'hide';} else{antiimgtmb = '';}
if(data2.link == false){tumblr.posts[numberpost]["link-url"] = ''; antilinktmb = 'hide';} else{antilinktmb = '';}
if(data2.video == false){tumblr.posts[numberpost]["video-player"] = ''; antivideotmb = 'hide';} else{antivideotmb = '';}
if(data2.tags == false){tagtumblr = ''; anttagstmb = 'hide';}
...
if((data.type == "tags") && (data2.force_disable_tag == false)){var tumblr_click_tagspk = function(thisclick){window.open($(thisclick).attr('the_href'), '_blank');}}
else {var tumblr_click_tagspk = function(thisclick){load_tumblr_disable_click(); $(thishere).tumblr(data, data2, true, 0, antiscroll, $(thisclick).attr('tumblr_tag'));}}

if(tumblr.posts[numberpost].tags != undefined){for (tagnumber = 0; tagnumber < tumblr.posts[numberpost].tags.length; tagnumber++) {
...
// Disable all
if((data2.info == false) && (data2.like == false) && (data2.reblog == false) && (data2.like == false) && (data2.date == false) && (data2.music == false) && (data2.photo == false) && (data2.link == false) && (data2.video == false) && (data2.tags == false)){newtitlecss = 'tumblr_hideall_config';}
else{newtitlecss = '';}

// Photo
if(tumblr.posts[numberpost].type == "photo"){if(data2.disable_photo != true){
...
// Video
else if(tumblr.posts[numberpost].type == "video"){if(data2.disable_video != true){
$('#'+$(thishere).attr('id')+" .tumblr_posts").append(
$("<div>",{class: "tumblr_post"}).append(
...
// Audio
else if(tumblr.posts[numberpost].type == "audio"){if(data2.disable_audio != true){
$('#'+$(thishere).attr('id')+" .tumblr_posts").append(
$("<div>",{class: "tumblr_post"}).append(
...
// Regular
else if(tumblr.posts[numberpost].type == "regular"){if(data2.disable_regular != true){
if(tumblr.posts[numberpost]["regular-title"] == ""){var titlest = chrome.i18n.getMessage("tumblr_postdefaultname");}
else{var titlest = tumblr.posts[numberpost]["regular-title"];}
$('#'+$(thishere).attr('id')+" .tumblr_posts").append(
$("<div>",{class: "tumblr_post"}).append(
...
// Link
else if(tumblr.posts[numberpost].type == "link"){if(data2.disable_link != true){
if(tumblr.posts[numberpost]["link-text"] == ""){var titlest = chrome.i18n.getMessage("tumblr_postdefaultname");}
else{var titlest = tumblr.posts[numberpost]["link-text"]+" >";}
$('#'+$(thishere).attr('id')+" .tumblr_posts").append(
$("<div>",{class: "tumblr_post"}).append(
...
// Quote
else if(tumblr.posts[numberpost].type == "quote"){if(data2.disable_quote != true){
if(tumblr.posts[numberpost]["quote-text"] == ""){var titlest = chrome.i18n.getMessage("tumblr_postdefaultname");}
else{var titlest = tumblr.posts[numberpost]["quote-text"];}
$('#'+$(thishere).attr('id')+" .tumblr_posts").append(
$("<div>",{class: "tumblr_post"}).append(
...
// Conversation
else if(tumblr.posts[numberpost].type == "conversation"){if(data2.disable_conversation != true){
if(tumblr.posts[numberpost]["conversation-title"] == ""){var titlest = chrome.i18n.getMessage("tumblr_postdefaultname");}
else{var titlest = tumblr.posts[numberpost]["conversation-title"];}
...
// Numbers Page
if(tumblr["posts-total"] > load_tumblr_lm){tumblr_pages_count_br = Math.ceil(tumblr["posts-total"]/load_tumblr_lm);}
else{tumblr_pages_count_br = 1;}
...
if(data2.pagination == specialnumber1){if(data.page+1 < specialnumber2-data2.pagination){
...
if((data2.pagination == 4) && (data.page+1 == tumblr_pages_count_br)){number_tumblr_page_st(11-data2.pagination, "previous");}
else if((data2.pagination == 4) && (data.page+2 == tumblr_pages_count_br)){number_tumblr_page_st(10-data2.pagination, "previous");}
else if((data2.pagination == 4) && (data.page+3 == tumblr_pages_count_br)){number_tumblr_page_st(9-data2.pagination, "previous");}
else if((data2.pagination == 4) && (data.page+4 == tumblr_pages_count_br)){number_tumblr_page_st(8-data2.pagination, "previous");}

else{number_tumblr_page_st(8-data2.pagination, "previous");}
}
...
if((data2.pagination == 3) && (data.page+1 == tumblr_pages_count_br)){number_tumblr_page_st(8-data2.pagination, "previous");}
else if((data2.pagination == 3) && (data.page+2 == tumblr_pages_count_br)){number_tumblr_page_st(7-data2.pagination, "previous");}
else if((data2.pagination == 3) && (data.page+3 == tumblr_pages_count_br)){number_tumblr_page_st(6-data2.pagination, "previous");}

else if((data2.pagination == 4) && (data.page+1 == tumblr_pages_count_br)){number_tumblr_page_st(10-data2.pagination, "previous");}
else if((data2.pagination == 4) && (data.page+2 == tumblr_pages_count_br)){number_tumblr_page_st(9-data2.pagination, "previous");}
else if((data2.pagination == 4) && (data.page+3 == tumblr_pages_count_br)){number_tumblr_page_st(8-data2.pagination, "previous");}

else{number_tumblr_page_st(7-data2.pagination, "previous");}
}
...
if((data2.pagination == 2) && (data.page+1 == tumblr_pages_count_br)){number_tumblr_page_st(5-data2.pagination, "previous");}
else if((data2.pagination == 2) && (data.page+2 == tumblr_pages_count_br)){number_tumblr_page_st(4-data2.pagination, "previous");}

else if((data2.pagination == 3) && (data.page+1 == tumblr_pages_count_br)){number_tumblr_page_st(7-data2.pagination, "previous");}

else if((data2.pagination == 4) && (data.page+1 == tumblr_pages_count_br)){number_tumblr_page_st(9-data2.pagination, "previous");}
else if((data2.pagination == 4) && (data.page+2 == tumblr_pages_count_br)){number_tumblr_page_st(8-data2.pagination, "previous");}

else{number_tumblr_page_st(6-data2.pagination, "previous");}
}
...
if((data2.pagination == 1) && (data.page+1 == tumblr_pages_count_br)){number_tumblr_page_st(2-data2.pagination, "previous");}

else if((data2.pagination == 2) && (data.page+1 == tumblr_pages_count_br)){number_tumblr_page_st(4-data2.pagination, "previous");}

else if((data2.pagination == 3) && (data.page+1 == tumblr_pages_count_br)){number_tumblr_page_st(6-data2.pagination, "previous");}

else if((data2.pagination == 4) && (data.page+1 == tumblr_pages_count_br)){number_tumblr_page_st(8-data2.pagination, "previous");}

else{number_tumblr_page_st(5-data2.pagination, "previous");}
}
...
(tumblr_pages_count_br >= 2) && (data.page+1+1 < tumblr_pages_count_br))
{numbert_tumblr_page_px(1, "next", 1, 3);}

if((data2.pagination >= 2) && 
(tumblr_pages_count_br >= 3) && (data.page+1+2 < tumblr_pages_count_br))
{numbert_tumblr_page_px(2, "next", 2, 5);}

if((data2.pagination >= 3) && 
(tumblr_pages_count_br >= 4) && (data.page+1+3 < tumblr_pages_count_br))
{numbert_tumblr_page_px(3, "next", 3, 7);}

if((data2.pagination >= 4) && 
(tumblr_pages_count_br >= 5) && 
(data.page+1+4 < tumblr_pages_count_br))
{numbert_tumblr_page_px(4, "next", 4, 9);}
...
// New Page
if(data2.next_top == 2){$("#"+$(thishere).attr('id')+' .tumblr_top_next_page').append($("<ul>", {class: "pagination tumblr_next_sts"}).append(tumblr_next_st))}
else if(data2.next_top >= 0){
...
// Scroll
if(data2.scroll == true){if(antiscroll != true){
if(data2.scroll_item == 'auto_tumblr'){var auto_scroll_target_tumblr = thishere;}
else{var auto_scroll_target_tumblr = data2.scroll_item;}
...
'disable_photo': false, 'disable_video': false, 'disable_link': false, 'disable_audio': false, 'disable_regular': false, 'disable_quote': false, 'disable_conversation': false
}
