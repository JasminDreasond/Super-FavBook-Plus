...
function changepagesforscd(mynmbxs) {
    ...
    if (mynmbxs == "start") {
        chrome.storage.local.get({ maxitemfor: 10 }, function(config) {
...
function changensfwfilter(mynmbxs) {
    ...
    if (mynmbxs == "start") {
        chrome.storage.local.get({ nsfw_filter: true }, function(config) {
            nsfw_filter = config.nsfw_filter;

            if (config.nsfw_filter == true) { $("#nsfwfilter .glyphicon").addClass("glyphicon-ok"); } else { $("#nsfwfilter .glyphicon").addClass("glyphicon-remove"); }
...
function changeanti_spoiler_filter(mynmbxs) {
    ...
    if (mynmbxs == "start") {
        chrome.storage.local.get({ anti_spoiler_filter: true }, function(config) {
            anti_spoiler_filter = config.anti_spoiler_filter;

            if (config.anti_spoiler_filter == true) { $("#anti_spoiler_filter .glyphicon").addClass("glyphicon-ok"); } else { $("#anti_spoiler_filter .glyphicon").addClass("glyphicon-remove"); }
...
// System
function startfavpage(folderid) {
    chrome.bookmarks.getSubTree(folderid, function(foldercfg) {
        ...
        function backgroundchangedetectclick(detectbackstart) {
            ...
            if (backgroundchangedetect == true) {
                if (detectbackstart == true) { $("#imgpreview, #backchangecolor").addClass("backchhangepx"); } else {
                ...
                if (detectbackstart == true) { $("#imgpreview, #backchangecolor").removeClass("backchhangepx"); } else {
        ...
        function nextimagestpx(typeclick, detectautonext) {
            ...
            if (typeclick == "next") {
                typepsxanex = "next"
                if (pageclicknumberp == pageclicknumberpmax) {
                    pageclicknumberp = 0
                ...
                pageclicknumberp = pageclicknumberp - 1
                if (pageclicknumberp == 0) {
                    pageclicknumberp = Number(pageclicknumberpmax)
        ...
        function generatorimages(data, number, start, startid, folderset, oldfolder) {
            ...
            function generatordv(thumbdata) {
                ...
                function addrightclickclass(thishere) {
                    if (thumbdata.rightclicktype == false) {} else { $(thishere).addClass("selectedplusthumbpx"); }
                }
            ...
            function loopcreatordv() {
                ...
                if (urlpage == null) {} else { if (data[artcountpx].url.indexOf('?q=') > -1) { data[artcountpx].url = data[artcountpx].url.split('?q=')[0]; } }
                ...
                if (start == "subfolder") { loadingset(false); } else if (oembed_url == "undefined") { loopcreatordv(); } else if (cancelload == true) {
                    ...
                    // Image Generator
                        ...
                        if ((urlpage.indexOf(".deviantart.com") > -1) || (urlpage.startsWith("https://derpibooru.org/")) || (urlpage.startsWith("http://sta.sh/")) || (urlpage.startsWith("https://sta.sh/")) || (urlpage.startsWith("https://cdn.discordapp.com/attachments/"))) {
                            ...
                            //Validar URL
                            if ((validatorurlda == "http://www.deviantart.com/") || (validatorurlda == "https://www.deviantart.com/") || (urlpage.startsWith("http://fav.me/")) || (urlpage.startsWith("https://fav.me/")) || (urlpage.startsWith("http://sta.sh/")) || (urlpage.startsWith("https://sta.sh/")) || (validatorurlda.startsWith("https://derpibooru.org/")) || (validatorurlda.startsWith("https://cdn.discordapp.com/attachments/"))) {
                                ...
                                if ((start == true) || (start == "homepage")) {} else {
                                    ...
                                    if ((validatorurlda == "http://www.deviantart.com/") || (validatorurlda == "https://www.deviantart.com/") || (urlpage.startsWith("http://fav.me/")) || (urlpage.startsWith("https://fav.me/")) || (urlpage.startsWith("http://sta.sh/")) || (urlpage.startsWith("https://sta.sh/"))) {
                                        ...
                                        if ((urlpage.indexOf("deviantart.com/journal/") > -1) || (urlpage.indexOf("deviantart.com/journal/") > -1) || (urlpage.indexOf("deviantart.com/art/") > -1) || (urlpage.indexOf("deviantart.com/art/") > -1) || (urlpage.indexOf("www.deviantart.com/") > -1) || (urlpage.startsWith("http://sta.sh/")) || (urlpage.startsWith("https://sta.sh/")) || (urlpage.startsWith("http://fav.me/")) || (urlpage.startsWith("https://fav.me/"))) {
                                            $.ajax({ cache: false, dataType: "json", url: "http://backend.deviantart.com/oembed?url=" + oembed_url })
                                                .done(function(deviantart) {
                                                    ...
                                                    if ((deviantart.type == "photo") || (deviantart.type == "rich") || (deviantart.type == "link")) {
                                                        generatordv({
                                                            "img": deviantart.thumbnail_url,
                                                            "height": deviantart.thumbnail_height,
                                                            "url": urlinsertxs,
                                                            "title": deviantart.title,
                                                            "author_url": deviantart.author_url,
                                                            "author_name": deviantart.author_name,
                                                            "type": deviantart.type,
                                                            "realimg": deviantart.url,
                                                            "provider": providerselectda,
                                                            "artid": urldeviantart2,
                                        ...
                                        else if (enableurlmode == false) {
                                            if ((urlpage.indexOf("deviantart.com/gallery/") > -1) || (urlpage.indexOf("deviantart.com/favourites/") > -1)) {
                                                ...
                                                function deviantart_open_web(theurl_page) {
                                                    ...
                                                    $.ajax({ cache: false, url: theurl_page }).done(function(data) {
                                                        ...
                                                        if (($(data).find(".pagination .pages .next a").attr("class") != "disabled") || ($(data).find(".pagination .pages .prev a").attr("class") != "disabled")) {
                                                            $(data).find(".pagination .pages li").each(function() {
                                                                if ($(this).attr("class") != "dotdotdot") {
                                                        ...
                                                        $(data).find(finddefaultpage).each(function() {
                                                            ...
                                                            if (($(itemselectart).attr("class").indexOf("ismature") > -1) && (nsfw_filter == true)) {
                                                                ...
                                                                ) { var thumbimageclick = thumbimageclick2; } else if (
                                                            ...
                                                            if (
                                                                ...
                                                                ($(itemselectart).attr("data-super-full-img") != undefined) &&
                                                                ($(itemselectart).attr("data-super-full-img") != "")
                                                            ) { var deviantarttype = "photo"; } else if (
                                                                ($(itemselectart).attr("class").indexOf("thumb") > -1) &&
                                                                ($(itemselectart).attr("data-super-img") != null) &&
                                                                ($(itemselectart).attr("data-super-img") != undefined) &&
                                                                ($(itemselectart).attr("data-super-img") != "")
                                                            ) { var deviantarttype = "photo"; } else if ($(itemselectart).attr("class").indexOf("literature") > -1) { var deviantarttype = "rich"; } else { var deviantarttype = "link"; }
                                                            ...
                                                            generatordv({
                                                                "img": thumbimageclick,
                                                                "height": "auto",
                                                                "url": $(itemselectart).attr("href"),
                                                                "title": $(itemselectart).find(".info .title-wrap .title").text(),
                                                                "author_url": $(itemselectart).find(".info .extra-info .artist > a").attr("href"),
                                    ...
                                    // Discord
                                    else if (urlpage.startsWith("https://cdn.discordapp.com/attachments/")) {
                                        if ((urlpage.toLowerCase().endsWith(".jpg")) || (urlpage.toLowerCase().endsWith(".png")) || (urlpage.toLowerCase().endsWith(".gif")) || (urlpage.toLowerCase().endsWith(".bmp")) || (urlpage.toLowerCase().endsWith(".webp"))) {
                                            ...
                                            generatordv({
                                                ...
                                                "height": "auto",
                                                "url": urlpage,
                                                "title": chrome.i18n.getMessage("app_dp_discord_attachment"),
                                                "author_url": "https://discordapp.com/",
                                                "author_name": chrome.i18n.getMessage("unknown"),
                                                "type": "photo",
                                                "realimg": urlpage,
                                        ...
                                        if (
                                            ...
                                            function derpibooru_open_web(theurl_page) {
                                                ...
                                                $.ajax({ cache: false, url: theurl_page }).done(function(data) {
                                                    ...
                                                    // Criar Paginação
                                                    if ($(data).find(".block__header--light .pagination").attr("class") == "pagination") {
                                                        $(data).find(".block__header--light .pagination a, .block__header--light .pagination span").each(function() {
                                                            if ($(this).attr("class") != undefined) {
                                                                ...
                                                                // Prev Next
                                                                    ...
                                                                    if ($(this).attr("class") == "js-prev") { var clicktext = "«"; } else if ($(this).attr("class") == "js-next") { var clicktext = "»"; }
                                                    ...
                                                    $(data).find(finddefaultpage).each(function() {
                                                        ...
                                                        if ((real_webimages_json.full != undefined) && (real_webimages_json.full != null)) { var real_webimages = fixurl_web2 + real_webimages_json.full; } else if ((real_webimages_json.tall != undefined) && (real_webimages_json.tall != null)) { var real_webimages = fixurl_web2 + real_webimages_json.tall; } else if ((real_webimages_json.medium != undefined) && (real_webimages_json.medium != null)) { var real_webimages = fixurl_web2 + real_webimages_json.medium; } else if ((real_webimages_json.thumb != undefined) && (real_webimages_json.thumb != null)) { var real_webimages = fixurl_web2 + real_webimages_json.thumb; } else if ((real_webimages_json.thumb_small != undefined) && (real_webimages_json.thumb_small != null)) { var real_webimages = fixurl_web2 + real_webimages_json.thumb_small; } else if ((real_webimages_json.thumb_tiny != undefined) && (real_webimages_json.thumb_tiny != null)) { var real_webimages = fixurl_web2 + real_webimages_json.thumb_tiny; }



                                                        if ((real_webimages_json.medium != undefined) && (real_webimages_json.medium != null)) { var thumb_img = fixurl_web2 + real_webimages_json.medium; } else if ((real_webimages_json.thumb != undefined) && (real_webimages_json.thumb != null)) { var thumb_img = fixurl_web2 + real_webimages_json.thumb; } else if ((real_webimages_json.thumb_small != undefined) && (real_webimages_json.thumb_small != null)) { var thumb_img = fixurl_web2 + real_webimages_json.thumb_small; } else if ((real_webimages_json.thumb_tiny != undefined) && (real_webimages_json.thumb_tiny != null)) { var thumb_img = fixurl_web2 + real_webimages_json.thumb_tiny; }
                                                        ...
                                                        for (i = 0; i < real_webimages_tags.length; i++) {
                                                            ...
                                                            if ((artistname_web == undefined) || (artistname_web == null)) { var artistname_web = chrome.i18n.getMessage("unknown"); }
                                                        ...
                                                        generatordv({
                                                            ...
                                                            "height": "auto",
                                                            "url": urlpage_web,
                                                            "title": title_webimage.substring(0, 35) + "...",
                                                            "author_url": sourceurl_web,
                                                            "author_name": artistname_web,
                                                            "type": type_derp,
                                                            "realimg": real_webimages,
                                                            "provider": "https://derpibooru.org/",
                                                            "rightclicktype": "derpibooru",
                                                            "web": true,
                                                            "numberpage": numberpageweb
                                                        });
                                        ...
                                        // Image
                                            ...
                                            $.ajax({ cache: false, dataType: "json", url: "https://derpibooru.org/oembed.json?url=" + urlpage })
                                                .done(function(derpibooru) {
                                                    ...
                                                    if (derpibooru.type == "photo") {
                                                        generatordv({
                                                            "img": "https://" + derpibooru.thumbnail_url,
                                                            "height": "",
                                                            "url": urlinsertxs,
                                                            "title": "Derpibooru",
                                                            "author_url": derpibooru.author_url,
                                                            "author_name": derpibooru.author_name,
                                                            "type": derpibooru.type,
                                                            "realimg": "https://" + derpibooru.thumbnail_url,
                                                            "provider": "https://derpibooru.org/",
                                                            "artid": false,
                                                            "rightclicktype": "derpibooru"
                                                        });
...
function closerecpagespx(exittype) {
    if (exittype == "normal") { $("#importpagesmodal").modal('toggle'); } else {
...
function updatepagesforsec(loadingtype) {
    $.ajax({ cache: false, url: "https://www.deviantart.com/settings/browsing", dataType: "html" })
        .done(function(data) {
            ...
            if (getconfigop == null) { pagesforsec = 24; } else { pagesforsec = Number(getconfigop) }
                            ...
                            chrome.bookmarks.search({ "title": chrome.i18n.getMessage("app_dp_folder") }, function(favdata) {
                                chrome.bookmarks.create({ "parentId": favdata[0].id, "title": webpagename }, function(newfavpxsd) {
                                    $(data).find(finddefaultpage).each(function() {
                                        ...
                                        if ((nsfw_filter == true) || (anti_spoiler_filter == true)) {
                                            for (i = 0; i < real_webimages_tags.length; i++) {
...
$("#importtype").change(function() {
    ...
    if ($(this).val() == "deviantart") { $("#import_deviantart").removeClass("hide"); } else if ($(this).val() == "derpibooru") { $("#import_derpibooru").removeClass("hide"); }
...
chrome.extension.onMessage.addListener(function(message, sender, sendResponse) {
    if (message.text == "updateconfig") {
        sendResponse({ type: "updateconfig2" })

        $("#importpagesmodal").addClass("hide");
        loadingset(true);
        ...
        $.ajax({ cache: false, url: "https://www.deviantart.com/settings/browsing" })
            .done(function(data) {
                var getconfigop = $(data).find(".browse-limit .spacemenus").val();
                if (getconfigop == null) { pagesforsec = 24 } else { pagesforsec = Number(getconfigop) }
                $("#importpagesmodal").removeClass("hide");
                loadingset(false);
            })
...
function autodetecturlpxs2(thishere) {
    if (($(thishere).val().startsWith("https://derpibooru.org/") > -1) || ((thishere).val().startsWith("http://derpibooru.org/") > -1)) {
        ...
        if ($(thishere).val().indexOf("derpibooru.org/search?q=") > -1) {
            $("#favtypesf2").val("search?q=");
            removepxsurlk("search?q=");
        } else if ($(thishere).val().indexOf("derpibooru.org/search/") > -1) {
            $("#favtypesf2").val("search/");
            removepxsurlk("search/");
        } else if ($(thishere).val().indexOf("derpibooru.org/galleries/") > -1) {
            $("#favtypesf2").val("galleries/");
            removepxsurlk("galleries/");
        }
...
$("#excodefolder").click(function() {
    if ($('#folderlist .active').attr('folderidreg') != undefined) {
        chrome.bookmarks.getSubTree($('#folderlist .active').attr('folderidreg'), function(foldercfg) {
...
function loadsystemcssclick() {
    chrome.storage.local.get({ loadsync: 'local', dp_css: '' }, function(settings) {
        if (settings.loadsync == 'sync') {
            chrome.storage.sync.get({ dp_css: '' }, function(settings2) {
