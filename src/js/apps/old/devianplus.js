...
// Derpibooru
    ...
    if (
        ...
        function sendloadimageda_derp(playimagest) {
            if ((playimagest == "send") || (playimagest == "next")) {
                ...
                $.ajax({ cache: false, url: urlpage + completeurlsx }).done(function(data) {
                        ...
                        var numberpageweb = 0;
                        if (page_web_nav == 0) { page_web_nav_cache.push({ "title": webpagename, "url": webpagename_url });
                        ...
                        $(data).find(finddefaultpage).each(function() {
                            ...
                            page_web_nav_cache[page_web_nav].items.push({
                                "img": fixurl_web2 + $(itemselectart).find("a img").attr("src"),
                                "height": "auto",
                                "url": urlpage_web,
                        ...
                        } else { loadingset(false);
                            pagesforsecresult = 0;
                            web_creatorst(); }
                    })
                    .fail(function() { loadingset(false);
